<footer class="p-2 flex justify-center flex-col gap-y-4 border-t">
    <div class="flex justify-between items-center px-4 max-lg:flex-col max-lg:items-start max-lg:gap-y-6">
        <div class="w-50 h-12">
            <img src="{{ URL::asset('images/IxoraSawLogo.png') }}" alt=""
                class="w-50 h-12 object-cover">
        </div>
        ...
        <div class="bg-gray-100 p-4 flex justify-center flex-col gap-y-2 w-[500px] max-lg:w-full max-lg:m-auto">
    ...
    <div class="mt-4">
        ...
        <ul class="flex justify-center items-center gap-x-2 select-none">
            <li>
                <a href="" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30"
                        viewBox="0 0 50 50" class="fill-[#5A5858]">
                        <path
    ...
    <div>
        <ul class="flex justify-center gap-x-4 mt-8 mb-3 select-none">
            <li>
                <svg title="Visa" class="cursor-pointer" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <svg title="American Express" class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" role="img"
            ...
            <li>
                <svg title="Maestro" class="cursor-pointer" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <svg title="Mastercard" class="cursor-pointer" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <svg title="Shop Pay" class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" role="img"
                    viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-shopify_pay">
                    <title id="pi-shopify_pay">Shop Pay</title>
                    <rect x=".5" y=".5" width="37" height="23" rx="2" fill="#5A31F4"
                        stroke="#3F22AB"></rect>
                    <path
            ...
            <li>
                <svg title="PayPal" class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="24" height="24" viewBox="0 0 48 48">
                    <title id="pi-shopify_pay">PayPal</title>
